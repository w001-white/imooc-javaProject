 ...
 * 需求分析
 * 播放列表管理主要功能:
 * 将歌曲添加到主播放列表·将歌曲添加到普通播放列表
 * 通过歌曲id查询播放列表中的歌曲通过歌曲名称查询播放列表中的歌曲修改播放列表中的歌曲
 * 删除播放列表中的歌曲.显示播放列表中的所有歌曲
 * <p>
 * 播放器管理主要功能:·
 * 向播放器添加播放列表
 * 从播放器删除播放列表
...
public class Test {
    ...
    public void SongTest() {
        ...
        System.out.println("song1 == song2?" + (song1.equals(song2)));// false
        System.out.println("song3 == song4?" + (song3.equals(song4)));// true
